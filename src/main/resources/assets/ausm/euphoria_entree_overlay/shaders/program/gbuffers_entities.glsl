...
uniform int ausmAstralEffectOverlay;
...
void main() {
    ...
    color *= glColor;
    bool ausmUnlitAstralOverlay = ausmAstralEffectOverlay == 1;
    ...
    if (alphaCheck > 0.001 && !ausmUnlitAstralOverlay) {
