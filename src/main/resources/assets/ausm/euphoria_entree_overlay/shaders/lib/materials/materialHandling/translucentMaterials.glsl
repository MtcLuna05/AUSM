...
#include "/lib/materials/materialMethods/ausmModdedFluidCheck.glsl"
    ...
    } else if (ausmIsModdedColoredFluid) {
        #include "/lib/materials/specificMaterials/translucents/coloredFluid.glsl"
    } else if (mat >= 32000) {
        if (mat < 32004) { // Water
            #ifdef SHADER_WATER
