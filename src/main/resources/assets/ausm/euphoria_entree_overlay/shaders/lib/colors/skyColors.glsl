    ...
    #define INCLUDE_SKY_COLORS
    ...
    #ifdef OVERWORLD
        #if defined GBUFFERS_SKYBASIC && defined AUSM_SIMPLE_VOID_WORLD
            vec3 skyColorTweaked = vec3(0.5, 0.66275, 1.0) * sunVisibility;
        #elif defined SAVE_SKYBOX_DATA
        ...
        // The shared sky-color include does not define skyColorTweaked for
        // modded-dimension programs. The Dreadlands sky is supplied by AUSM's
        // dedicated shader-owned sky path instead.
        #if 0
