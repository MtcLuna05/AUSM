...
import static com.l.ausm.impl.pipeline.PipelineProbeLimits.MAX_PIPELINE_PASS_PROBE_LOGS;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.CHUNK_FADE_DURATION_SECONDS;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.CHUNK_FADE_STALE_FRAMES;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.CHUNK_FADE_WARMUP_FRAMES;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.ENABLE_CHUNK_FADE;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.MAX_CHUNK_FADE_STATES;
...
abstract class PipelineRuntimeDiagnosticsState6 extends PipelineRuntimeDiagnosticsState5 {
    ...
    public void setCurrentEntity(Entity entity) {
        ...
        currentEntityId = self().entityId(currentEntityKey);
