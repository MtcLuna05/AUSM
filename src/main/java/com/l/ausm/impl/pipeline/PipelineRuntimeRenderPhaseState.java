...
import static com.l.ausm.impl.pipeline.PipelineProbeLimits.MAX_NOTHIRIUM_NON_SOLID_PROVIDER_DRAW_LOGS;
import static com.l.ausm.impl.pipeline.PipelineProbeLimits.MAX_NOTHIRIUM_NON_SOLID_REPAIR_LOGS;
import static com.l.ausm.impl.pipeline.PipelineProbeLimits.MAX_NOTHIRIUM_SPARSE_MAIN_REPAIR_LOGS;
import static com.l.ausm.impl.pipeline.PipelineProbeLimits.MAX_WATER_ATTACHMENT_DELTA_PROBE_LOGS;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.HARDWARE_TERRAIN_FALLBACK_SPARSE_OPAQUE_DRAWS;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.NOTHIRIUM_NON_SOLID_PROVIDER_DRAW_FRAMES;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.NOTHIRIUM_NON_SOLID_REPAIR_COOLDOWN_FRAMES;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.NOTHIRIUM_SPARSE_MAIN_PROVIDER_CUTOUT_DISTANCE;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.NOTHIRIUM_SPARSE_MAIN_PROVIDER_CUTOUT_MAX_CHUNKS;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.NOTHIRIUM_SPARSE_MAIN_PROVIDER_DRAW_FRAMES;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.NOTHIRIUM_SPARSE_MAIN_PROVIDER_SOLID_DISTANCE;
import static com.l.ausm.impl.pipeline.PipelineTerrainConstants.NOTHIRIUM_SPARSE_MAIN_PROVIDER_SOLID_MAX_CHUNKS;
