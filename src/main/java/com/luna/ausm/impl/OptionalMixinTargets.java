...
final class OptionalMixinTargets {
    private static final Map<String, OptionalMixinTarget> TARGETS = Map.ofEntries(
            ...
            target("CreativeCoreBufferBuilderUtilsMixin", "com/creativemd/creativecore/client/rendering/model/BufferBuilderUtils.class", false),
            target("LittleTilesChunkBlockLayerCacheMixin", "com/creativemd/littletiles/client/render/cache/ChunkBlockLayerCache.class", false),
            target("LittleTilesChunkBlockLayerManagerMixin", "com/creativemd/littletiles/client/render/cache/ChunkBlockLayerManager.class", false),
