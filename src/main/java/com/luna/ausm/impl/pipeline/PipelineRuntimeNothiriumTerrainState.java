...
import com.luna.ausm.api.pipeline.shader.FogMode;
import com.luna.ausm.api.pipeline.shader.LightingModel;
...
import static com.luna.ausm.impl.pipeline.PipelineProbeLimits.MAX_NOTHIRIUM_MAIN_SETUP_BRIDGE_LOGS;
import static com.luna.ausm.impl.pipeline.PipelineProbeLimits.MAX_NOTHIRIUM_SPARSE_MAIN_PROVIDER_DRAW_LOGS;
...
abstract class PipelineRuntimeDiagnosticsState5 extends PipelineRuntimeDiagnosticsState4 {
    ...
    protected int nothiriumFallbackBlockEntityId(BlockRenderLayer layer) {
        // A non-extended Nothirium VBO contains no per-block material data.
        // Never label an entire translucent section as water: that turns ice,
        // particles behind it, and any modded glass into water shader input.
        return 0;
    }
