...
import static com.luna.ausm.impl.pipeline.PipelineProbeLimits.MAX_STEADY_VANILLA_TERRAIN_DIAGNOSTIC_LOGS;
    ...
    protected String externalRenderCaller() {
        ...
        for (StackTraceElement frame : stack) {
            ...
            if (className.equals(Thread.class.getName())
                    ...
                    || className.equals("com.luna.ausm.impl.mixin.pipeline.RenderSkyMixin")
