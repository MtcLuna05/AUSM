...
final class MinecraftReflectionCompatTest {
    ...
    void inheritedLookupSurvivesMissingOptionalTypeInUnrelatedMethod() throws Exception {
        ...
        String parentName = "com.luna.ausm.test.generated.SafeParent" + suffix;
        String childName = "com.luna.ausm.test.generated.PoisonedChild" + suffix;
        String missingName = "com.luna.ausm.test.generated.MissingOptionalType" + suffix;
